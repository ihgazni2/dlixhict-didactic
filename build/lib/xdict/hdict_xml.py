...
def html_to_hdict(**kwargs):
    ...
    while(unhandled.__len__()>0):
        ...
        for i in range(0,unhandled.__len__()):
            ...
            parent_deepth_path = copy.deepcopy(parent_path)
            ...
            for j in range(0,children.__len__()):
                ...
                path = parent_path
                parent_bps_path = copy.deepcopy(unhandled[i]['breadth_path'])
                parent_bps_path.append(breadth)
                parent_orig_obj_path = copy.deepcopy(unhandled[i]['orig_obj_path'])
